...
variable "all_zones" {
  ...
  default = [
    ...
    { environment = "prod", region = "aws-use1-az2", tag = "prod.aws-use1-az2" },
    { environment = "prod", region = "aws-use2-az1", tag = "prod.aws-use2-az1" },
    { environment = "prod", region = "aws-use2-az2", tag = "prod.aws-use2-az2" },
    ...
    { environment = "prod", region = "aws-eun1-az1", tag = "prod.aws-eun1-az1" },
...
variable "az_by_region" {
  ...
  default = {
    ...
    aws-use2-az2        = "use2-az2",
    aws-use2-az1        = "use2-az1",
    aws-use1-az4        = "use1-az4",
    aws-use1-az2        = "use1-az2",
